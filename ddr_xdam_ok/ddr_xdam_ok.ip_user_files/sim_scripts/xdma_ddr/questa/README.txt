...
#
# Generated by export_simulation on Fri Apr 26 10:05:49 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './xdma_ddr.sh' script.

./xdma_ddr.sh -reset_run
...
./xdma_ddr.sh -noclean_files

For more information on the script, please type './xdma_ddr.sh -help'.
