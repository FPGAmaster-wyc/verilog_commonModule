...
HD_PWD='E:/my_work/QT7013/vivado2019/OK/ddr_xdam_ok/ddr_xdam_ok.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log xdma_ddr_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source xdma_ddr_wrapper.tcl
