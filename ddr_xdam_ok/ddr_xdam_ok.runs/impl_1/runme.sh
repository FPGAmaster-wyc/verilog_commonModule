...
HD_PWD='E:/my_work/QT7013/vivado2019/OK/ddr_xdam_ok/ddr_xdam_ok.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log xdma_ddr_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source xdma_ddr_wrapper.tcl -notrace
