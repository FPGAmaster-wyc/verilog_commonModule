...
HD_PWD='E:/my_work/QT7013/vivado2019/OK/ddr_xdam_ok/ddr_xdam_ok.runs/xdma_ddr_mig_7series_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log xdma_ddr_mig_7series_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source xdma_ddr_mig_7series_0_0.tcl
